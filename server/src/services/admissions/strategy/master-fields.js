...
const MASTER_FIELD_POOL = {
    ...
    birth_native: {
        ...
        fields: [
            ...
            { key: "native_country", label: "Native Country", type: "text" },
            { key: "native_state", label: "Native State", type: "text" },
            { key: "native_district", label: "Native District", type: "text" },
    ...
    permanent_address: {
        ...
        fields: [
            ...
            { key: "permanent_country", label: "Permanent Country", type: "text" },
            { key: "permanent_state", label: "Permanent State", type: "text" },
            { key: "permanent_district", label: "Permanent District", type: "text" },
