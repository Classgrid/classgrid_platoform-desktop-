    ...
    <div className={cn("bg-card border border-border rounded-xl shadow-sm flex flex-col", className)}>
      ...
      <div className="p-5 flex flex-col gap-4">
        ...
        <div className="relative flex items-center mt-2">
          <div className="w-full bg-background border border-border/50 rounded-lg py-2.5 pl-3 pr-12 font-mono text-sm text-foreground overflow-x-auto whitespace-nowrap">
            {value}
          </div>
          <button
            onClick={handleCopy}
