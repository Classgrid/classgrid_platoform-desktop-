...
interface CgSwitchProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'type' | 'role'> {
  onCheckedChange?: (checked: boolean) => void;
}

export const CgSwitch = React.forwardRef<HTMLInputElement, CgSwitchProps>(
      ...
      >
        ...
        <div
          className={cn(
            ...
            "peer-checked:bg-blue-600 dark:peer-checked:bg-blue-600 peer-checked:group-hover:bg-blue-500 dark:peer-checked:group-hover:bg-blue-500",
