...
export function LoginPageShell({ leftPanel, rightPanel }: LoginPageShellProps) {
  return (
    <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#09090b]">
      ...
      {/* ── Main Container ── */}
      <div className="relative z-10 flex w-[94%] max-w-[1250px] overflow-hidden rounded-[24px] border border-white/[0.08] bg-[#0a0a0a] shadow-2xl" style={{ height: "88vh", minHeight: "750px" }}>
