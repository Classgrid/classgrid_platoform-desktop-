  ...
  return (
    ...
    <main className="h-screen w-screen bg-[#0f0f0f]">
      ...
      <div className="grid h-full w-full grid-cols-1 lg:grid-cols-2 overflow-hidden">
        ...
        {/* 3. LEFT PANEL                               */}
        {/* ═══════════════════════════════════════════ */}
        <section className="relative flex flex-col bg-[#0f0f0f] border-r border-white/[0.15] overflow-hidden">
          ...
          <div className="absolute top-6 left-6 z-10">
            <a 
              ...
              className="flex h-[40px] items-center gap-2 rounded-full border border-white/20 bg-black/40 px-5 text-[13px] font-semibold text-white backdrop-blur-md transition-colors hover:bg-black/60"
            >
            ...
            <div className="flex w-full max-w-[500px] flex-col justify-center rounded-[24px] border border-white/[0.15] bg-[#0f0f0f] px-10 py-8 shadow-xl">
              ...
              {step === 1 ? (
                ...
                <form onSubmit={handleVerifyDevice} className="flex flex-col">
                  <Button type="button" onClick={() => setStep(1)} className="mb-4 inline-flex w-fit items-center gap-2 text-[14px] font-medium text-white/60 transition-colors hover:text-emerald-400">
                    <ArrowLeft className="h-4 w-4" /> Back
                  </Button>
                  <h2 className="text-center text-[22px] font-bold text-[#ededed]">Verify this device</h2>
