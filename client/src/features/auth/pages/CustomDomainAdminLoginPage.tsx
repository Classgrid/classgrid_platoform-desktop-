            ...
            {step === 1 ? (
              <form onSubmit={handleLogin} className="flex flex-col" aria-busy={isSubmitting}>
                ...
                <div className="mt-3 flex items-center justify-between">
                  <label className="flex items-center gap-3" htmlFor="custom-admin-remember-me">
                    <input id="custom-admin-remember-me" name="rememberMe" type="checkbox" checked={rememberMe} onChange={(event) => setRememberMe(event.target.checked)} className="h-4 w-4 accent-[#10b981]" />
