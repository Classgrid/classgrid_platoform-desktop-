...
export function LeadsPage() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-[100%] mx-auto p-4 sm:p-6 lg:p-8 pb-12">
      ...
      <SectionPanel 
        title="Lead Pipeline" 
        description='Click "Manage" on any lead to approve, schedule meeting, or contact.' 
