...
export interface CMSPageEditorRef {
  clear: () => void;
  getHTML: () => string;
  getFiles: () => File[];
}
...
const CMSPageEditor = forwardRef<CMSPageEditorRef, CMSPageEditorProps>(
  ({ onChange, initialHTML = "", placeholder = "Write page content here...", minHeight = 360, onSubmit }, ref) => {
...
CMSPageEditor.displayName = "CMSPageEditor";
