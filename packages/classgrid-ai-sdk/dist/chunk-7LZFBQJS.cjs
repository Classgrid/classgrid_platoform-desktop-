...
var officeParser__namespace = /*#__PURE__*/_interopNamespace(officeParser);
...
async function extractTextFromAttachment(url, mimeType) {
  try {
    ...
    const text = await officeParser__namespace.parseOffice(buffer);
...
exports.answerChatWithGeminiNatively = answerChatWithGeminiNatively;
exports.createLLMClient = createLLMClient;
exports.describeImageWithGemini = describeImageWithGemini;
exports.extractPdfWithGemini = extractPdfWithGemini;
exports.extractResponse = extractResponse;
exports.extractTextFromAttachment = extractTextFromAttachment;
//# sourceMappingURL=chunk-7LZFBQJS.cjs.map
//# sourceMappingURL=chunk-7LZFBQJS.cjs.map